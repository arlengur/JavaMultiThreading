 ...
 * queue is no longer full. Because the a_base thread has already checked the
 ...
 * progress until the a_base thread has actually blocked.
 *
 ...
 * safely take out the a_base connection. This checking and removing will be
...
public class BlockingQueueApp {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread t2 = new Thread(new Runnable() {
            public void run() {
                try {
                    Thread.sleep(1000);//wait for putting to the queue a_base
